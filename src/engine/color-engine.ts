...
const INDUSTRY_PROFILES: Record<Industry, IndustryColorProfile> = {
  ...
  technology: {
    primaries: ['#2563EB', '#3B82F6', '#1D4ED8', '#1E40AF'],
    secondaries: ['#06B6D4', '#0891B2', '#0EA5E9', '#22D3EE'],
    accents: ['#F59E0B', '#EAB308', '#FBBF24', '#FCD34D'],
  ...
  creative: {
    primaries: ['#EC4899', '#8B5CF6', '#06B6D4', '#F97316'],
    secondaries: ['#10B981', '#6366F1', '#EF4444', '#14B8A6'],
    accents: ['#FBBF24', '#F43F5E', '#A855F7', '#22D3EE'],
    recommendedTheme: 'auto',
  ...
  luxury: {
    primaries: ['#1C1917', '#292524', '#0A0A0A', '#1A1A2E'],
    secondaries: ['#D4A843', '#B8860B', '#C5932A', '#DAA520'],
    accents: ['#F5F0E8', '#FFFBF0', '#FFF8E7', '#F8F0E3'],
    recommendedTheme: 'dark',
    avoid: ['#3B82F6', '#22C55E', '#667eea'],
  },
  startup: {
    primaries: ['#2563EB', '#7C3AED', '#059669', '#EC4899'],
    secondaries: ['#06B6D4', '#F59E0B', '#10B981', '#6366F1'],
    accents: ['#F43F5E', '#FBBF24', '#22D3EE', '#A855F7'],
    recommendedTheme: 'light',
    avoid: ['#667eea', '#764ba2'],
  },
  corporate: {
